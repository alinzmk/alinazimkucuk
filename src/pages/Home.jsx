      ...
      <header className="App-header ">
        ...
        <div className="row ABOUTME ">
          <div className="col-12 col-lg-6 m-auto pe-lg-5">
            ...
            <h4 className='home-text2'>
              You can reach me via my social media accounts and ask me personally but, 
              if you feel lazy here it is a summary <span className='dot'>.</span>
            </h4>
          </div>
          <div className="col-12 col-lg-6 d-flex m-0 ps-lg-5 justify-content-center">
            <h5 className='m-auto'>
                I study in Computer Engineering in 5 years (prepration class included ofc :)), I love to design
                things and make them concrete using Web Development gitar spor humor
              </h5>
          </div>
        </div>
